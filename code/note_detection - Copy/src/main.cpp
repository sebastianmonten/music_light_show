...
//---------------------------------------here is the code from: https://create.arduino.cc/projecthub/abhilashpatel121/arduino-music-notes-and-chord-detector-728b14
...
#define Mic_pin A14
#define zero_shift 500
#define threshold  40 // initially set to 3
//---------------------------------------------------------------------------//
...
void setup() {
Serial.begin(115200);
// Mic_pin = A14;   // change as per Microphone pin
}
